...
function prana_post_author() {
	...
	$output = sprintf( '%3$s<span class="entry-author author vcard"><a href="%1$s" title="'. __( 'by %2$s', 'prana' ) .'" rel="author">%2$s</a></span>', esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ), esc_html( get_the_author() ), prana_entry_meta_sep() );
	return $output;
...
<div class="grid_5 grid_credit">
  <?php printf( __( '%s Theme by', 'prana' ), $prana_theme_data['Name'] ); ?> <a href="<?php echo $prana_theme_data['AuthorURI']; ?>" title="DesignOrbital">DesignOrbital</a> &sdot; <a href="http://wordpress.org/" title="WordPress">WordPress</a>
</div>
<?php	
}
